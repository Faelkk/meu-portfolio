...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-40 flex justify-center border-b border-gray-200/70 bg-gray-50/80 backdrop-blur-xl dark:border-white/8 dark:bg-[#0a0d12]/80">
      <nav className="flex h-20 w-full max-w-7xl items-center justify-between px-6 lg:px-10" aria-label={content.navigation.ariaLabel}>
        <a className="group flex items-center gap-3" href="#inicio" aria-label={content.navigation.homeLabel}>
        ...
        <button className="rounded-lg border border-gray-200 p-2.5 text-gray-900 dark:border-white/10 dark:text-white lg:hidden" onClick={handleOpenModal} aria-label={content.navigation.openMenu}>
