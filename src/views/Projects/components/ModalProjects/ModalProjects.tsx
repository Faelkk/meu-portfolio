      ...
      projectModal && (
        ...
        >
          <section className="flex items-stretch  gap-4 flex-col md:flex-row   w-full">
            <section className="flex p-5 rounded-md  flex-col items-center justify-center bg-woodsmoke-800 md:pb-3 md:px-0 ">
            ...
            <section className="flex gap-2   flex-col max-w-225  md:mt-0 justify-between w-full">
              ...
              <div className="bg-woodsmoke-800  my-3 md:my-0 flex flex-col gap-6  p-3 ">
